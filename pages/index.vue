  ...
  div
    ...
    section#case
      div.container.center
        h2.subTtl.underline こんなときに便利！
        div
          no-ssr
            carousel(v-if="showCarousel" :per-page="1" :autoplay="true" :autoplayTimeout=4000 :loop="true" paginationColor="#aaa")
              slide
                div.lead.lead__carousel
                  div.lead__img
                  ...
                  h3
                    ...
                    | で働きたい！
                  div.lead__txt
                    p 派遣会社によって紹介先はまちまち。他の派遣会社の人に、「〇〇周辺で働きやすい職場はある？」といった質問をしてみましょう。
              slide
                div.lead.lead__carousel
                  div.lead__img
                    img(src="/img/hakentalk-case-where.svg" width="200" alt="")
                  h3
                    span.underline ここの職場
                    | ってどう？
                  div.lead__txt
                    p 初見の職場は不安がつきもの。どんなことするの？そもそも入口どこですか？そんな派遣あるあるも、気軽に質問してみましょう。
              slide
                div.lead.lead__carousel
                  div.lead__img
                    img(src="/img/hakentalk-case-ohmygod.svg" width="200" alt="")
                  h3 うわっ・・
                    span.underline 私の時給、低すぎ・・
                    | ？
                  div.lead__txt
                    p 同じ職場でも派遣会社によって時給が違ったり、交通費がでたりでなかったり。そんなときは、同じ職場の人にこっそり聞きましょう。
              slide
                div.lead.lead__carousel
                  div.lead__img
                    img(src="/img/hakentalk-case-lonely.svg" width="200" alt="")
                  h3 派遣って
                    span.underline 孤独なんですけど
                    | ？
                  div.lead__txt
                    p 職場の人と仲良くなるには時間がかかります。そんなときは、趣味の話でもしてみましょう。きっと、同じ趣味の人もいるはずです。

        div.container.step.flex.flex--space-between.flex--center
          div.step__item
            div.areaButton(@click="$router.push('/area')")
              img(src="/img/icon-japan.svg" alt="")
              span 会議を探す
          div.step__item
            div.areaButton(@click="$router.push('/talks')")
              img(src="/img/icon-chat-border.svg" alt="")
              span 会議を開く
          div.step__item
            div.areaButton(@click="$router.push('/guide')")
    ...
    section#recent
      div.container
        div.center
          h2.subTtl.underline ただいま、会議中！
        div.flex.flex--space-between.flex--wrap.mt-3
          div.talk(v-for="(talk, index) in talks" :key="index")
            talk(:talk="talk")
      div.center
        button.button.button--round.button--yellow(@click="$router.push('/area')") もっと見る

    section#rule
      div.container
        div.center
          h2.subTtl.underline ルールを守ろう！
        div.lead
          h3 派遣会議は、
            span.underline みなさんの信頼
            | で成り立っています。
          p 派遣会議は公共の場です。みなさんで気持ちよく使っていただくため、以下の投稿はご遠慮ください。
          ol
            li 公序良俗に反する投稿
            li 犯罪的行為、またはそれらに結びつく投稿
            li 第三者の知的所有権（著作権・意匠権・特許権・実用新案権・商標権・ノウハウが含まれるがこれに限定されない）を侵害する投稿
            li 第三者の財産、信用、プライバシーを侵害する投稿
            li 第三者に不利益を与える投稿
            li 第三者を誹謗中傷する投稿
            li 当サイトの運営を妨げる、または、当方の信用を毀損する投稿
            li その他、法律に反する投稿
            li 本サイトの利用者として有する権利を第三者に転売、再販売、譲渡、若しくはこれに類する投稿

    section#news
      div.container
        div.center
          h2.subTtl.underline お知らせ
        ul.news
