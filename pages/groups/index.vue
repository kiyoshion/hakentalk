    ...
    div.container
        div.flex.flex--center
            ...
            div(v-if="isLogin && !$store.state.user.isAnonymous")
                button.button.button--yellow.button--round(@click="toggleModal") グループを作る
            ...
            div.modal.modal--full(v-if="isOpenModal" key="div" @click.self="isOpenModal=!isOpenModal")
                div.modal__inner
                    ...
                    div.formGroup.formGroup--buttons.center
                        ...
                        button.button.button--yellow.button--round(@click="createGroup") グループを作る
</template>
...
export default {
    ...
    data() {
        return {
            ...
            meta: {
                title: 'グループ一覧',
                description: 'グループでは、最後の一言だけ残ります。',
                type: 'article',
